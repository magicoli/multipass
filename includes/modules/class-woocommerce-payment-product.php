		...
		$meta_boxes[] =  [
			...
			'fields'         => [
				[
					...
					'desc' => sprintf(
						'<p>%s</p><p>%s</p>',
						__('Payment products are used to provide a payment gateway for prestation not handled by WooCommerce (like deposits, custom items or services handled by an external website).', 'multiservices' ),
						join(
							'<br/>', array(
